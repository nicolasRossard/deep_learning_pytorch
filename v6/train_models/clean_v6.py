...
Useful if shipsnet.json is used
'''
import torch
...
# Cleaning data JSON
## get local file path and bool for shuffling or not
## return numpy arrays vith dataset cleaned
def clean_data(filepath,b_shuffle):
...
def save_dataframe_minio(client, bucket_name, csv_name, df):
    print('{}: save_dataframe_minio function'.format(os.path.basename(__file__)))
